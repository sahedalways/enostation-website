  ...
  return (
    <section id="experience" className="section--alt">
      <ScrollReveal direction="none">
        <p className="section-eyebrow">Our Arsenal</p>
        <h2>Technologies We Master</h2>
        <p className="section-subtitle">
          Full-stack expertise across frontend, backend, and cloud - built for performance and scale.
        </p>
      </ScrollReveal>
      ...
      <div className="container tech-stack-grid" id="responsive">
        {filteredTech.map((tech, index) => (
          <ScrollReveal key={tech.name} delay={Math.min(index * 0.05, 0.3)}>
            <div className="tech-card glass-card" style={{ '--tech-color': tech.color }}>
              <div className="tech-card-header">
                <div className="tech-icon-wrap" role="img" aria-label={`${tech.name} technology icon`}>
                  {tech.icon}
                </div>
